...
export const findPetsByStatus = (
    params: FindPetsByStatusParams,
      ...
      return createRequest<Pet[]>(
      {url: `/v3/pet/findByStatus`, method: 'GET',
        params
    },
      );
    }
...
export const findPetsByTags = (
    params: FindPetsByTagsParams,
      ...
      return createRequest<Pet[]>(
      {url: `/v3/pet/findByTags`, method: 'GET',
        params
    },
      );
    }
...
export const deletePet = (
    petId: number,
      ...
      {url: `/v3/pet/${petId}`, method: 'DELETE'
    },
      );
    }
...
export const uploadFile = (
    ...
    params?: UploadFileParams,
      ...
      {url: `/v3/pet/${petId}/uploadImage`, method: 'POST',
...
export const getInventory = (
      ...
      {url: `/v3/store/inventory`, method: 'GET'
    },
      );
    }
...
export const placeOrder = (
    order: Order,
      ...
      {url: `/v3/store/order`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: order
    },
      );
...
export const getOrderById = (
    orderId: number,
      ...
      return createRequest<Order>(
      {url: `/v3/store/order/${orderId}`, method: 'GET'
    },
      );
    }
...
export const deleteOrder = (
    orderId: number,
      ...
      return createRequest<null>(
      {url: `/v3/store/order/${orderId}`, method: 'DELETE'
    },
      );
    }
...
export const createUsersWithListInput = (
    user: User[],
      ...
      return createRequest<User>(
      {url: `/v3/user/createWithList`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: user
    },
      );
...
export const getUserByName = (
    username: string,
      ...
      return createRequest<User>(
      {url: `/v3/user/${username}`, method: 'GET'
    },
      );
    }
...
export const updateUser = (
    ...
    user: User,
      ...
      return createRequest<null>(
      {url: `/v3/user/${username}`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
      data: user
    },
      );
...
export const deleteUser = (
    username: string,
      ...
      return createRequest<null>(
      {url: `/v3/user/${username}`, method: 'DELETE'
    },
      );
    }
